...
class Adventure:
    def __init__(self, client, type):
        ...
        self.scene_number = 0 #maybe add an additional "starting info" to let the ai generate a different type of start?
    ...
    def from_db(cls, client, data: dict) -> "Adventure":
        ...
        adventure.scene_number = data["scene_number"]
    ...
    def parse_adventure_response(self, response: str):
        ...
        self.advance_status()
        history_dict = {"text": adventure_text, "options": options, "scene_number": self.scene_number}
